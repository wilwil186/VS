...
%%%%%%%%%%%%%%%%%%% Comienzo ejemplo de la función PolCar
% Calcular el polinomio característico
[f, p] = PolCar(A);
disp('polinomio característico')
disp(p)
%%%%%%%%%%%%%%%%%%% Fin ejemplo de la función PolCar

%%%%%%%%%%%%%%%%%%%% Comienzo ejemplo de la función mullerMethodHolder
% Coeficientes del polinomio
coeficientes = p;

% Llamar a la función mullerMethodHolder con los coeficientes
raiz = mullerMethodHolder(coeficientes, 0, 1e-6, 100);

% Mostrar las raíces del polinomio
fprintf('Las raíces del polinomio son:\n');
disp(raiz);

%%%%%%%%%%%%%%%%%%%% Fin ejemplo de la función mullerMethodHolder
...
function [f, p] = PolCar(A)
   ...
   polinomio = determinante(A - lambda*I,n);
